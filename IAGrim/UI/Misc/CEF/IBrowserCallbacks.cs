...
namespace IAGrim.UI.Misc.CEF {
    public interface IBrowserCallbacks {
        ...
        void SetItems(List<List<JsonItem>> items, int numItemsFound, bool hasMore, bool numItemsApproximate = false, bool orderByQuantity = false, bool duplicatesOnly = false);
