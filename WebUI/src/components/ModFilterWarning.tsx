  ...
  render() {
    return (
      <div className={styles.outer}>
        <div className={`${styles.large} ${styles.yellow} ${styles.border} ${styles.panel} ${styles.container}`}>
          <button
            type="button"
            aria-label={localize('Dismiss warning permanently', '永久关闭警告')}
            className={`${styles.button} ${styles.large} ${styles.topright}`}
