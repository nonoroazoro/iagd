...
const helpEntries = [
    ...
    },
    {
      ...
      The most recent log is "log.txt"`)}
            The log folder is located at <i>&lt;IA installation directory&gt;\UserData</i>
        </div>,
        type: IHelpEntryType.Informational
    },
    {
    ...
    },
    {
      ...
      Go to the "data" folder`)}
            The data folder is located at <i>&lt;IA installation directory&gt;\UserData\data</i>
        </div>,
        type: IHelpEntryType.Informational
    },
    {
    ...
    },
    {
        ...
        body: () => <div>
            Yes, but it requires manual setup.<br/><br/>
            This is intended for power users: <br/>
            <ol>
                <li>Close IA</li>
                <li>Open the IA installation directory</li>
                <li>Copy the "UserData" folder to "D:\mystuff\UserData"</li>
                <li>Rename the original folder to "UserData-backup"</li>
                <li>Open a command prompt in the IA installation directory</li>
                <li>"cd /d &lt;IA installation directory&gt;"</li>
                <li>"mklink /j UserData D:\mystuff\UserData"</li>
                <li>Start IA</li>
                <li>If everything works correctly, delete the "UserData-backup" folder.</li>
            </ol>
            This creates a directory junction that is transparent to IA. The data is physically stored in
            "D:\mystuff\UserData", while IA continues reading the "UserData" path in its installation directory. <br/>
...
export class HelpEnglish extends PureComponent<Props, object> {
