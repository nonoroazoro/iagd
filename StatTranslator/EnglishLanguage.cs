...
namespace StatTranslator {
    public class EnglishLanguage : ILocalizedLanguage {
        ...
        private readonly Dictionary<string, string> _stats = new Dictionary<string, string> {
            ...
            {"iatag_ui_searchbox_placeholder", "Search items"},
            {"iatag_ui_grimtools_search_placeholder", "GrimTools build URL or ID"},
            {"iatag_ui_grimtools_search_tooltip", "Press Enter to search owned base items from a GrimTools build."},
            ...
            {"iatag_ui_resetsettings_error_title", "Error"},
            {"iatag_ui_resetsettings_invalid_restart", "Could not reset settings: invalid restart request."},
            {"iatag_ui_resetsettings_restart_error", "Could not reset settings and restart Item Assistant:\n{0}"},
            {"iatag_ui_resetsettings_complete_error", "Could not reset settings:\n{0}"},
            {"iatag_ui_safe_mode_running_title", "Item Assistant is already running"},
            {"iatag_ui_safe_mode_running_body", "Item Assistant is already running, look for the icon in the system tray next to the clock.\n\nClose the running instance and then start safe mode again."},
